...
-- Prg11.0 definition. Resets all thgroup_ facts if thgroup rst = 1.
--------------------------------------------------------------------------------
2 
...
-- Prg11.0 definition. Set thgroup rst = 0 if thgroup rst = 1.
--------------------------------------------------------------------------------
3
...
-- Prg11.0 definition. Mode hvel definition. Set factor_mode_thgroup_main on crs counter > 4.
--------------------------------------------------------------------------------
4
...
-- Prg11.0 definition. Mode thgroup main definition. Add factor thgroup main to thgroup main.
--------------------------------------------------------------------------------
5
...
-- Prg11.0 definition. Sets retro to zero power if main engine is on.
--------------------------------------------------------------------------------
6	
...
-- Prg11.0 definition. Open retro doors when retro engines are fired.
--------------------------------------------------------------------------------
7
...
-- Prg11.0 definition. Close retro doors when retro engines are idle.
--------------------------------------------------------------------------------
