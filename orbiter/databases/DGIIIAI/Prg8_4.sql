...
-- Prg8.4 definition. Reset mode rudder counter to zero on mode rudder zero.
--------------------------------------------------------------------------------
2	
...
-- Prg8.4 definition. tgt_hdg_err_cs to zero on mode rudder zero; this leads to avg on mode rudder 0.
...
-- Prg8.4 definition. Delete context cur ver prg8 when mode rudder is 0.
--------------------------------------------------------------------------------
-- Main
--------------------------------------------------------------------------------
4
...
-- Prg8.4 definition. Increases mode rudder counter on mode rudder 1.
--------------------------------------------------------------------------------
5 **

SELECT Value FROM sde_facts WHERE Item = 'mode_rudder' AND Value = 1	

UPDATE sde_facts SET Value = (SELECT Value FROM sde_facts WHERE Item = 'hdg') WHERE ( Value < 0 OR Value >= 360 ) AND Status = 'applykbrules' AND Item LIKE '%hdg'

-- Prg8.4 definition. Set headings to that of hdg.
--------------------------------------------------------------------------------
6
...
-- Prg8.4 definition. On mode rudder 1 and bank <= max_bank_rudder_t, increase tgt_hdg_err_cs by adding current rudder Value.
--------------------------------------------------------------------------------
7	
...
-- Prg8.4 definition. On mode rudder 1 and bank <= max_bank_rudder_t, calculate avg.
--------------------------------------------------------------------------------
8
...
-- Prg8.4 definition. On mode rudder 1 and bank <= max_bank_rudder_t, tgt_hdg_err_avg to rudder_t.
--------------------------------------------------------------------------------
9	
...
-- Prg8.4 definition. On mode rudder 1 and bank > max_bank_rudder_t, 0.00 to rudder_t.
--------------------------------------------------------------------------------
10	
...
-- Prg8.4 definition. Calculates tgt_yaw by inverting the yaw value.
--------------------------------------------------------------------------------
11	
...
-- Prg8.4 definition. Yaw damper actuator signal.
--------------------------------------------------------------------------------
12	
...
-- Prg8.4 definition. Check if hdg is on q1.
--------------------------------------------------------------------------------
13	
...
-- Prg8.4 definition. Check if tgt hdg is on q1.
--------------------------------------------------------------------------------
14	
...
-- Prg8.4 definition. Check if hdg is on q2.
--------------------------------------------------------------------------------
15	
...
-- Prg8.4 definition. Check if tgt hdg is on q2.
--------------------------------------------------------------------------------
16	
...
-- Prg8.4 definition. Check if hdg is on q3.
--------------------------------------------------------------------------------
17	
...
-- Prg8.4 definition. Check if tgt hdg is on q3.
--------------------------------------------------------------------------------
18	
...
-- Prg8.4 definition. Check if hdg is on q4.
--------------------------------------------------------------------------------
19	
...
-- Prg8.4 definition. Check if tgt hdg is on q4.
--------------------------------------------------------------------------------
20
...
-- Prg8.4 definition. Pos rudder value on hq1tq2.
--------------------------------------------------------------------------------
21	
...
-- Prg8.4 definition. Pos rudder value on hq1tq3.
--------------------------------------------------------------------------------
22
...
-- Prg8.4 definition. Neg rudder value on hq1tq4.
--------------------------------------------------------------------------------
23	
...
-- Prg8.4 definition. Neg rudder value on hq2tq1.
--------------------------------------------------------------------------------
24	
...
-- Prg8.4 definition. Pos rudder value on hq2tq3.
--------------------------------------------------------------------------------
25
...
-- Prg8.4 definition. Pos rudder value on hq2tq4.
--------------------------------------------------------------------------------
26
...
-- Prg8.4 definition. Neg rudder value on hq3tq1.
--------------------------------------------------------------------------------
27	
...
-- Prg8.4 definition. Neg rudder value on hq3tq2.
--------------------------------------------------------------------------------
28	
...
-- Prg8.4 definition. Pos rudder value on hq3tq4.
--------------------------------------------------------------------------------
29	
...
-- Prg8.4 definition. Pos rudder value on hq4tq1.
--------------------------------------------------------------------------------
30	
...
-- Prg8.4 definition. Pos rudder value on hq4tq2.
--------------------------------------------------------------------------------
31	
...
-- Prg8.4 definition. Neg rudder value on hq4tq3.
--------------------------------------------------------------------------------
32 *
...
-- Prg8.4 definition. Pos tgt rudder value on hq=tq h<t.
----------------------------------- ---------------------------------------------
33 *
...
-- Prg8.4 definition. Tgt rudder zero on h=t.
--------------------------------------------------------------------------------
35
...
-- Prg8.4 definition. Keep rudder on zero when on the ground and speed < vr.
--------------------------------------------------------------------------------
36
...
-- Prg8.4 definition. Rudder actuator signal.
--------------------------------------------------------------------------------
