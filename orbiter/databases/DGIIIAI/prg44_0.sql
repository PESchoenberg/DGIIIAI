-- prg44.0
-- Manages crew. This version just performs some checks on the number of crew members onboard and adds up a crew resource counter. This counter could be used later to calculate overall life support consumption.
--------------------------------------------------------------------------------
...
-- Prg44.0 definition. If there are no crew members onboard delete prg44 from sde_rules.
--------------------------------------------------------------------------------
...
UPDATE sde_facts SET Value = 0 WHERE Status = 'applykbrules' AND Item = 'crew_onb'

-- Prg44.0 definition. If qty of crew onboard < 0, set to zero.
--------------------------------------------------------------------------------
3
...
-- Prg44.0 definition. If value of crew max < crew min, set crew max to value of crew min.
--------------------------------------------------------------------------------
...
-- Prg44.0 definition. If there are crew onboard, update resource counter.
--------------------------------------------------------------------------------
