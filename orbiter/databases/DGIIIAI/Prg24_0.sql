-- prg24.0
-- Load initial batch of programs.
--------------------------------------------------------------------------------
1
...
UPDATE sde_facts SET Value = 24.0 WHERE Value = 0 AND Status='applykbrules' AND Item = 'submode_prg_load'	

Ship level definition. Prg24.0 definition. Load init programs. Set submode prg load to load prg24.0 on is_first_iteration = load_order_prg24 and > 2.
