...
-- Prg9.0 definition. Reset mode hato counter to zero on mode hato zero.
--------------------------------------------------------------------------------
2	
...
-- Prg9.0 definition. Delete cur ver Prg9 when mode hato is 0.
--------------------------------------------------------------------------------
3
...
-- Prg9.0 definition. Increases mode hato counter on mode hato 1.
--------------------------------------------------------------------------------
4	
...
-- Prg9.0 definition. Activate aerosurf_rst on hato counter = [1,2].
--------------------------------------------------------------------------------
5
...
-- Prg9.0 definition. Activate mode_thgroup_ on hato counter = [3,4].
--------------------------------------------------------------------------------
6
...
-- Prg9.0 definition. Set tgt speed for hato.
--------------------------------------------------------------------------------
7
...
-- Prg9.0 definition. Set tgt altitude for hato.
--------------------------------------------------------------------------------
8	
...
-- Prg9.0 definition. Set decision altitude.
--------------------------------------------------------------------------------
9
...
-- Prg9.0 definition. Set elev trim on 1 on hato counter = [5,6].
--------------------------------------------------------------------------------
10	
...
-- Prg9.0 definition. Set tgt pitch for hato mode on hato counter = [5,6].
--------------------------------------------------------------------------------
11
...
-- Prg9.0 definition. Auto trim to acquire tgt pitch on hato counter >= 10.
--------------------------------------------------------------------------------
12	
...
-- Prg9.0 definition. Set thgroup main = 1 on hato counter = [11,14].
--------------------------------------------------------------------------------
13	
...
-- Prg9.0 definition. Set tgt elev on 0.5 on airspeed >= vr and while still on ground.
--------------------------------------------------------------------------------
14
...
-- Prg9.0 definition. Set tgt elev on 0 once the ship passes 150 m AGL and until it reaches dec alt.
--------------------------------------------------------------------------------
15	
...
-- Prg9.0 definition. Reset all once alt over ground >= tgt alt on hato.
--------------------------------------------------------------------------------
16
...
-- Prg9.0 definition. Set yaw damper on when altitudeoverground >= dec_alt.
--------------------------------------------------------------------------------
17
...
-- Prg9.0 definition. Set yaw damper off when altitudeoverground < dec_alt.
--------------------------------------------------------------------------------
18	
...
-- Prg9.0 definition. Activate mode_ailer on hato counter = [3,4].
--------------------------------------------------------------------------------
19
...
-- Prg9.0 definition. Activate mode_rudder on hato counter = 3.
--------------------------------------------------------------------------------
20	
...
-- Prg9.0 definition. Set tgt ailer on 0 on hato counter = [5,6].
--------------------------------------------------------------------------------
21
...
-- Prg9.0 definition. Set tgt rudder on 0 on hato counter = [5,6].
--------------------------------------------------------------------------------
22	
...
-- Prg9.0 definition. Activate mode_elev on hato counter = [3,4].
--------------------------------------------------------------------------------
23	
...
-- Prg9.0 definition. Set tgt elev on 0 on hato counter = [5,6].
--------------------------------------------------------------------------------
24	
...
-- Prg9.0 definition. Mode doors close on hato counter = [1,2].
--------------------------------------------------------------------------------
25	
...
-- Prg9.0 definition. Mode extensions close on hato counter = [1,2].
--------------------------------------------------------------------------------
26	
...
-- Prg9.0 definition. Set tgt hdg on hdg value on airspeed >= vr and while still on ground.
--------------------------------------------------------------------------------
27
...
-- Prg9.0 definition. Set mode navmode control 1 on count of prg31 records = 0 on sde_rules.
--------------------------------------------------------------------------------
