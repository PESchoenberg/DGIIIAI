...
-- Prg24.2 definition. Mode thgroup definition. Set submode prg load to load cur ver prg11 on is_first_iteration = load_order_prg11.
--------------------------------------------------------------------------------
2	
...
-- Prg24.2 definition. Mode wpt definition. Set submode prg load to load cur ver prg12 on is_first_iteration = load_order_prg12.
--------------------------------------------------------------------------------
3	
...
-- Prg24.2 definition. Mode rst definition. Set submode prg load to load cur ver prg13 on is_first_iteration = load_order_prg13.
--------------------------------------------------------------------------------
4	
...
-- Prg24.2 definition. Mode lights definition. Set submode prg load to load cur ver prg14 on is_first_iteration = load_order_prg14.
--------------------------------------------------------------------------------
5	
...
-- Prg24.2 definition. Mode lights definition. Set submode prg load to load cur ver prg15 on is_first_iteration = load_order_prg15.
--------------------------------------------------------------------------------
6
...
-- Prg24.2 definition. Mode lgear definition. Set submode prg load to load cur ver prg16 on is_first_iteration = load_order_prg16.
--------------------------------------------------------------------------------
7
...
-- Prg24.2 definition. Mode extensions definition. Set submode prg load to load cur ver prg17 on is_first_iteration = load_order_prg17.
--------------------------------------------------------------------------------
8	
...
-- Prg24.2 definition. Mode doors definition. Set submode prg load to load cur ver prg18 on is_first_iteration = load_order_prg18.
--------------------------------------------------------------------------------
9	
...
-- Prg24.2 definition. Mode elev definition. Set submode prg load to load cur ver prg19 on is_first_iteration = load_order_prg19.
--------------------------------------------------------------------------------
10	
...
-- Prg24.2 definition. Energy system. Set submode prg load to load cur ver prg20 on is_first_iteration = load_order_prg20.
--------------------------------------------------------------------------------
11	
...
-- Prg24.2 definition. Airbrakes. Set submode prg load to load cur ver prg21 on is_first_iteration = load_order_prg21.
--------------------------------------------------------------------------------
12
...
-- Prg24.2 definition. Mode taxi. Set submode prg load to load cur ver prg22 on is_first_iteration = load_order_prg22.
--------------------------------------------------------------------------------
13
...
-- Prg24.2 definition. Mode all rst. Set submode prg load to load cur ver prg23 on is_first_iteration = load_order_prg23.
--------------------------------------------------------------------------------
14
...
-- Prg24.2 definition. Delete cur ver prg24 on is_first_iteration = delete_order_prg24.
--------------------------------------------------------------------------------
15
...
-- Prg24.2 definition. Navmode management. Set submode prg load to load cur ver prg31 on is_first_iteration = load_order_prg31.
--------------------------------------------------------------------------------
