...
-- Prg6.1 definition. Inhibit mode wpt if mode wpt is on but no enabled records are found at sde_wpt.
--------------------------------------------------------------------------------
2
...
-  Prg6.1 definition. Update tgt alt with tgt wpt alt data.
--------------------------------------------------------------------------------
3
...
-- Prg6.1 definition. Update tgt speed with tgt wpt speed data.
--------------------------------------------------------------------------------
4
...
-- Prg6.1 definition. Update tgt hdg with leg_rel_equ_brg data.
--------------------------------------------------------------------------------
