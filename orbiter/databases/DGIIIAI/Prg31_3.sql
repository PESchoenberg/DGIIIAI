...
-- Prg31.3 definition. Toggle mode navmode control off once loaded.
--------------------------------------------------------------------------------
2

SELECT A.Value FROM ( ( SELECT Value FROM sde_facts WHERE Item = 'mode_hato' ) AS A JOIN ( SELECT Value FROM sde_facts WHERE Item = 'mode_crs' ) AS B ) WHERE A.Value = 0 AND B.Value = 0

DELETE FROM sde_rules WHERE Context = ( SELECT ( 'prg' || CAST( ( SELECT Value FROM sde_facts WHERE Item = 'cur_ver_prg31' ) AS TEXT ) ) )

-- Prg31.3 definition. If mode hato = 0 and mode crs = 0, delete prg31 from sde_rules.
--------------------------------------------------------------------------------
3
...
-- Prg31.3 definition. Mode hato. Mode trs. Inhibit navmodes on mode hato, mode trs on.
--------------------------------------------------------------------------------
4
...
-- Prg31.3 definition. Mode crs. If crs is on and tgt_alt = altitudeoverground, activate navmode hlevel.
--------------------------------------------------------------------------------
5
...
-- Prg31.3 definition. Mode crs. If crs is on and tgt_alt != altitudeoverground, deactivate navmode hlevel.
--------------------------------------------------------------------------------
6
...
-- Prg31.3 definition. Mode crs. If tgt alt = altitudeoverground and mode crs is on and holdalt is off, turn holdalt on.
--------------------------------------------------------------------------------
7
...
-- Prg31.3 definition. Mode crs. If altitudeoverground < tgt_alt * min_alt_multiplier or altitudeoverground > tgt_alt * max_alt_multiplier and crs = 1, then set off navmode holdalt.
--------------------------------------------------------------------------------
8
...
-- Prg31.3 definition. Mode crs. Inhibit navmodes on tgt hdg != hdg and mode crs = 1.
--------------------------------------------------------------------------------
9
...
-- Prg31.3 definition. Mode crs. Inhibit navmode_prograde on mode crs on.
--------------------------------------------------------------------------------
10
...
-- Prg31.3 definition. Mode crs. Inhibit navmode_retrograde on mode crs on.
--------------------------------------------------------------------------------
11
...
-- Prg31.3 definition. Mode crs. Inhibit navmode_normal on mode crs on.
--------------------------------------------------------------------------------
12
...
-- Prg31.3 definition. Mode crs. Inhibit navmode_antinormal on mode crs on.
--------------------------------------------------------------------------------
13
...
-- Prg31.3 definition. Mode crs. Inhibit navmode_killrot on mode crs on.
--------------------------------------------------------------------------------
14
...
-- Prg31.3 definition. Mode crs. Cut off stray thgroup hover > 0 when navmode holdalt = 0 an mode crs = 1.
--------------------------------------------------------------------------------
15
...
-- Prg31.3 definition. Mode crs. Cut off stray thgroup hover > 0 when navmode holdalt = 0 an mode hato = 1.
--------------------------------------------------------------------------------
16
...
-- Prg31.3 definition. Mode crs. Cut off *att_pitchup and *att_pitchdown when their values are equal, mode crs is on and navmode hlevel is off.
--------------------------------------------------------------------------------
17
...
-- Prg31.3 definition. Mode crs. Cut off *att_up and *att_down when their values are equal, mode crs is on and navmode hlevel is off.
--------------------------------------------------------------------------------
18
...
-- Prg31.3 definition. Mode crs. Cut off stray thgroup bank != 0 when navmode hlevel = 0 an mode crs = 1.
--------------------------------------------------------------------------------
