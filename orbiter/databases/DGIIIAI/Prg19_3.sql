...
-- Prg19.3 defintion. Mode elev definition. Calculate tgt elev from pitch and tgt pitch.
--------------------------------------------------------------------------------
2	
...
-- Prg19.3 defintion. Mode elev definition. Truncate elev_t to -1 value if < -1.
--------------------------------------------------------------------------------
3	
...
-- Prg19.3 definition. Mode elev definition. Truncate tgt elev to -1 value if < -1.
--------------------------------------------------------------------------------
5
...
-- Prg19.3 definition. Mode elev definition. Mode elev actuator signal.
--------------------------------------------------------------------------------
